...
add_child_mortality = function(is_child_mortality_needed, country){
  children = read.csv(paste0('DATA/children/child_raw_', country, '_m.csv'))
  ...
  if (is_child_mortality_needed){
    ...
    write_csv(path = paste0('DATA/children/child_all_', country, '_m.csv'), child_and_m)
    ...
    write_csv(path = paste0('DATA/children/child_all_list_', country, '_m.csv'), plot_c_and_m) 
  } else{
  ...
  child_and_m = read.csv(paste0('DATA/children/child_all_', country, '_m.csv'))
...
process_children_mortality_england_wales = function(){
  ...
  data = readxl::read_xls('DATA/England&Wales/mortality_england_wales_xy.xls', sheet = 3)
...
process_infant_mortality_england_wales = function(){
  ...
  data = read.csv('DATA/England&Wales/infant_england_wales_xy.csv')
