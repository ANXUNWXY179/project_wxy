...
set_rdhs_config(
  email = 'xw320@ic.ac.uk',
  project = 'Total mortality orphans',
  cache_path = 'C:/Users/40991/Desktop/project_wxy/DATA/DHS',
...
if (country == "co"){
  ...
  questions <- search_variables(datasets$FileName, variables = vars)
  extract <- extract_dhs(questions, add_geo = FALSE)
  data <- rbind_labelled(extract$KEPR52FL)
  extract_male_fertility(data = data, country_code = "ke", year = "08")
  ...
  questions <- search_variables(datasets$FileName, variables = vars)
  extract <- extract_dhs(questions, add_geo = FALSE)
  data <- rbind_labelled(extract$UGPR7BFL)
  extract_male_fertility(data = data, country_code = "ug", year = "16")
  ...
  questions <- search_variables(datasets$FileName, variables = vars)
  extract <- extract_dhs(questions, add_geo = FALSE)
  data <- rbind_labelled(extract$UGPR61FL)
  extract_male_fertility(data = data, country_code = "ug", year = "11")
  ...
  questions <- search_variables(datasets$FileName, variables = vars)
  extract <- extract_dhs(questions, add_geo = FALSE)
  data <- rbind_labelled(extract$UGPR52FL)
  extract_male_fertility(data = data, country_code = "ug", year = "06")
  ...
  questions <- search_variables(datasets$FileName, variables = vars)
  extract <- extract_dhs(questions, add_geo = FALSE)
  data <- rbind_labelled(extract$ETPR71FL)
  extract_male_fertility(data = data, country_code = "et", year = "16")
  ...
  questions <- search_variables(datasets$FileName, variables = vars)
  extract <- extract_dhs(questions, add_geo = FALSE)
  data <- rbind_labelled(extract$ETPR61FL)
  extract_male_fertility(data = data, country_code = "et", year = "11")
  ...
  questions <- search_variables(datasets$FileName, variables = vars)
  extract <- extract_dhs(questions, add_geo = FALSE)
  data <- rbind_labelled(extract$ETPR51FL)
  extract_male_fertility(data = data, country_code = "et", year = "05")
