...
# Kenya
  ...
  # extract_female_fertility(data = data, country_code = "ke", year = "08")
...
# Uganda
  ...
  extract_female_fertility(data = data, country_code = "ug", year = "16")
  ...
  extract_female_fertility(data = data, country_code = "ug", year = "11")
  ...
  print("here")
  extract_female_fertility(data = data, country_code = "ug", year = "06")
  print("done")
  ...
  # Weight and height per sex: "ha2", "hb2", "ha3", "hb3")
  questions <- search_variables(datasets$FileName, variables = vars)
  extract <- extract_dhs(questions, add_geo = FALSE)
  data <- rbind_labelled(extract$ETPR71FL)
  extract_female_fertility(data = data, country_code = "et", year = "16")
  ...
  extract_female_fertility(data = data, country_code = "et", year = "11")
  ...
  extract_female_fertility(data = data, country_code = "et", year = "05")
