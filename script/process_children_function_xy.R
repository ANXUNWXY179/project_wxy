...
process_children_father_england_wales = function(data_f){
  ...
  children[81, 18] <- data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date == 2002)]
  # A 80 year old would have had three year in 60+ age year category in 2002 and 2005
  children[80, 18:17] <- data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2002,2003))] 
  # A 79 year old would have had four year in 60-64 age year category in 2002 and 2005
  children[79, 18:16] <- data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2002,2004))] 
  # A 78 year old would have had 5 year in 60-64 age year category in 2002 and 2006
  children[78, 18:15] <- data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2002,2005))] 
  # A 77 year old would have had 5 year in 60-64 age year category in 2003 and 2007, one year in 55-59 in 2003
  
  children[77, 18:14] <- data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2002,2006))]
  
  children[76, 18:13] <- c(data_f$fertility_rate[which(data_f$age == "55-59" & data_f$date == 2002)],
                           data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2003,2007))])   
  
  children[75, 18:12] <-  c(data_f$fertility_rate[which(data_f$age == "55-59" & data_f$date%in% seq(2002, 2003))] ,
                            data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2004,2008))])
  
  children[74, 18:11] <-   c(data_f$fertility_rate[which(data_f$age == "55-59" & data_f$date%in% seq(2002, 2004))],
                             data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2005,2009))])   
  
  children[73, 18:10] <- c(  data_f$fertility_rate[which(data_f$age == "55-59" & data_f$date%in% seq(2002, 2005))] ,
                             data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2006,2010))])   
  
  children[72, 18:9] <- c(data_f$fertility_rate[which(data_f$age == "55-59" & data_f$date%in% seq(2002, 2006))] ,
                          data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2007,2011))]) 
  
  children[71, 18:8] <- c( data_f$fertility_rate[which(data_f$age == "50-54" & data_f$date == 2002)],
  ...
  children[70, 18:7] <- c( data_f$fertility_rate[which(data_f$age == "50-54" & data_f$date%in% seq(2002,2003))] ,
                           data_f$fertility_rate[which(data_f$age == "55-59" & data_f$date%in% seq(2004, 20089))] ,
                           data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2009,2013))])   
  
  children[69, 18:6] <- c( data_f$fertility_rate[which(data_f$age == "50-54" & data_f$date%in% seq(2002,2004))] ,
  ...
  children[68, 18:5] <- c( data_f$fertility_rate[which(data_f$age == "50-54" & data_f$date%in% seq(2002,2005))] ,
  ...
  children[67, 18:4] <- c(data_f$fertility_rate[which(data_f$age == "50-54" & data_f$date%in% seq(2002,2006))]  ,
  ...
  children[66, 18:3] <- c( data_f$fertility_rate[which(data_f$age == "45-49" & data_f$date == 2002)]  ,
                           data_f$fertility_rate[which(data_f$age == "50-54" & data_f$date%in% seq(2005,2007))] ,
  ...
  children[65, 18:2] <- c( data_f$fertility_rate[which(data_f$age == "45-49" & data_f$date%in% seq(2002,2003))]  ,
  ...
  children[64, 18:1] <- c( data_f$fertility_rate[which(data_f$age == "45-49" & data_f$date%in% seq(2002,2004))] ,
                           ...
                           data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2015,2018))])
  ...
  children[63, 18:1] <- c( data_f$fertility_rate[which(data_f$age == "45-49" & data_f$date%in% seq(2002,2005))] ,
                           ...
                           data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2016,2018))])
  ...
  children[62, 18:1] <- c(data_f$fertility_rate[which(data_f$age == "45-49" & data_f$date %in% seq(2002, 2006))],
                          ...
                          data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2017,2018))])
  ...
  children[51, 18:1] <- c(data_f$fertility_rate[which(data_f$age == "30-34" & data_f$date == 2002)]  , 
                          ...
                          data_f$fertility_rate[which(data_f$age == "45-49" & data_f$date == 2016)]  , 
                          data_f$fertility_rate[which(data_f$age == "45-49" & data_f$date == 2017)]  ,
                          data_f$fertility_rate[which(data_f$age == "50-54" & data_f$date == 2018)]  ,
...
process_children_father_55_plus = function(country, data_f){
  ...
  children[71, 18:1] <- c( data_f$fertility_rate[which(data_f$age == "50-54" & data_f$date == 2002)],
                           data_f$fertility_rate[which(data_f$age == "55+" & data_f$date%in% seq(2003, 2007))] ,
                           ...
                           data_f$fertility_rate[which(data_f$age == "55+" & data_f$date%in% seq(2018,2019))])
  ...
  children[70, 18:1] <- c( data_f$fertility_rate[which(data_f$age == "50-54" & data_f$date%in% seq(2002,2003))] ,
                           ...
                           data_f$fertility_rate[which(data_f$age == "55+" & data_f$date == 2019)])
  ...
  children[68, 18:1] <- c( data_f$fertility_rate[which(data_f$age == "50-54" & data_f$date%in% seq(2002,2005))] ,
                           ...
                           data_f$fertility_rate[which(data_f$age == "55+" & data_f$date %in% seq(2016, 2019))])
  ...
  children[67, 18:1] <- c(data_f$fertility_rate[which(data_f$age == "50-54" & data_f$date%in% seq(2002,2006))]  ,
                          ...
                          data_f$fertility_rate[which(data_f$age == "55+" & data_f$date %in% seq(2017, 2019))])
...
process_children_father_50_plus = function(country, data_f){
  ...
  children[100, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[99, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[98, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[97, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[96, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[95, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[94, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[93, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[92, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[91, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[90, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[89, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[88, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[87, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[86, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[85, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[84, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[83, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[82, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[81, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[80, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[79, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[78, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[77, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[76, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[75, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[74, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[73, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])
  children[72, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2019))])


  children[71, 18:1] <- c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date == 2002)],
                           data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2003, 2007))] ,
                           ...
                           data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2018,2019))])

  children[70, 18:1] <- c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2003))] ,
                           ...
                           data_f$fertility_rate[which(data_f$age == "50+" & data_f$date == 2019)])

  children[69, 18:1] <- c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2004))] ,
  ...
  children[68, 18:1] <- c( data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2005))] ,
                           ...
                           data_f$fertility_rate[which(data_f$age == "50+" & data_f$date %in% seq(2016, 2019))])

  children[67, 18:1] <- c(data_f$fertility_rate[which(data_f$age == "50+" & data_f$date%in% seq(2002,2006))]  ,
                          ...
                          data_f$fertility_rate[which(data_f$age == "50+" & data_f$date %in% seq(2017, 2019))])
...
process_children_father_65_plus = function(country, data_f){
  ...
  children[100, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[99, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[98, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[97, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[96, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[95, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[94, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[93, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[92, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[91, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[90, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[89, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[88, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[87, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[86, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[85, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[84, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[83, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])
  children[82, 18:1] <-  c( data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2002,2019))])

  children[81, 18:1] <- c(data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date == 2002)],
                          data_f$fertility_rate[which(data_f$age == "65+" & data_f$date %in% seq(2003, 2007))],
  ...
  children[77, 18:1] <- c(data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date %in% seq(2002, 2006))] ,
                          ...
                          data_f$fertility_rate[which(data_f$age == "65+" & data_f$date%in% seq(2017, 2019))])
  ...
  children[74, 18:1] <- c(data_f$fertility_rate[which(data_f$age == "55-59" & data_f$date == 2002)]  ,
                          ...
                          data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date == 2008)]  ,
                          data_f$fertility_rate[which(data_f$age == "60-64" & data_f$date == 2009)]  ,
                          data_f$fertility_rate[which(data_f$age == "65+" & data_f$date == 2010)]  ,
