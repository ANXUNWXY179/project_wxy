...
#   
#   iran <- select(d_rate_ihme, age, date, gender, fertility_rate)
#   
#   iran$age <- rep(c("20-24", "25-29", "30-34", "35-39", "40-44", "45-49", "50-54", "55+"), each = 17)
...
#   
#   ggplot() + 
#     geom_point(data = d_rate_ihme %>% filter(date == 2015), aes(age, fertility_rate), col = "pink") + 
